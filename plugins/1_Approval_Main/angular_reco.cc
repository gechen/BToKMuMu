...
{//{{{
	...
	double conYA[2]   = { 0.004,   0.004};
	double conYAerr[2]= { 0.096,   0.096};
	double conYF[2]   = { 0.095,   0.095};
	double conYFerr[2]= { 0.105,   0.105};
...
////	tl2->Draw();
	...
	leg->AddEntry(gen_fh,"GEN level "," lePf ");
	leg->SetLineColor(0);
	leg->SetFillColor(0);
	leg->SetBorderSize(0);
...
////	t2->DrawLatex(.82,.925,TString::Format("8 TeV"));
	...
	t1->DrawLatex(.27,.925,TString::Format("Simulation"));
