...
public :
  ...
  TTree *fChain; //!pointer to the analyzed TTree or TChain
   ...
   vector<int> *mumtrkqual; /* 2015-10-12 */
   vector<int> *muptrkqual; /* 2015-10-12 */
   ...
   TBranch *b_mumtrkqual; //! /* 2015-10-12 */
   TBranch *b_muptrkqual; //! /* 2015-10-12 */
   TBranch *b_mumdxyvtx; //!
   TBranch *b_mupdxyvtx; //!
   TBranch *b_mumdzvtx; //!
   TBranch *b_mupdzvtx; //!
   ...
   int SelectB(string);
   //int SelectB(string,int);
   bool HasGoodMuons(int);
   void SaveEvent(int);
	bool TriggerSelections(int);
	bool QualitySelections(int);
	bool AntiCutSelections(int);
	bool AntiJpsiSelections(int);
	bool AntiPsipSelections(int);
	bool PeakCutSelections(int);
	bool JpsiCutSelections(int);
	bool PsipCutSelections(int);
...
void SingleBuToKMuMuSelector::Init(TTree *tree)
{
   ...
   mumnormchi2 = 0;
   mupnormchi2 = 0;
   mumtrkqual = 0; /* 2015-10-12 */
   muptrkqual = 0; /* 2015-10-12 */
   mumdxyvtx = 0;
   mupdxyvtx = 0;
   mumdzvtx = 0;
   mupdzvtx = 0;
  ...
  // Set branch addresses and branch pointers
   ...
   fChain->SetBranchAddress("mumtrkqual", &mumtrkqual, &b_mumtrkqual); /* 2015-10-12 */
   fChain->SetBranchAddress("muptrkqual", &muptrkqual, &b_muptrkqual); /* 2015-10-12 */
