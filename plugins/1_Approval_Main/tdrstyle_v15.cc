...
// For the frame:
  ...
  tdrStyle->SetFrameLineWidth(2);   //// 1   /////  2 for q2 bins 2D projection plots
...
// Margins:
  ...
  tdrStyle->SetPadBottomMargin(0.30); //// 0.14   /////   0.30 for q2 bins 2D projection plots
...
// For the axis:
  ...
  tdrStyle->SetTickLength(0.04, "XYZ");
  tdrStyle->SetNdivisions(505, "XYZ");   //// 510  /////  5  for for q2 bins 2D projection plots
