...
def main():
    ...
    if args[0] == 'angular_gen':
        ...
        file_in = "../CutASelection/RootFiles/MC_Signal_8TeV_v4_AllCut_NoGEN.root"
        ibin = args[1]
        ...
        file_in = "fitParameters/reco_par_9.txt"
        ibin = args[1]
...
def call_fit_Eff_M(infile, ibin):
    ...
    for n in range(NLines):
        ...
        EffP4, EffP5, EffP6, EffP7, EffP8, EffP9, EffP10 = lines[0]
        count_a = linecache.getline('fitParameters/acc_par_9.txt',n+1)
        with open('fitParameters/temp.txt', 'w') as f:
            f.write(count_a)
        file = open('fitParameters/temp.txt', 'r')
        lines_a = [[float(digit) for digit in line.split()] for line in file]
        EffP1, EffP2, EffP3 = lines_a[0] 
