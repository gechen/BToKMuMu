...
def angular_gen(args):
    ...
    figname = 'angular_gen' + '_' + ibin + '_' + index

    if batch:
        jobname = 'fit'
        queue = '1nd'   ## 1 day
        cmd = create_batch_cmd(main='./fit')   ## 
        bashfile = set_file('/afs/cern.ch/user/g/gechen/gechen/work/BToKMuMu/Ana/GetApproval/', dirname, figname, '.sh', test=test)
...
def angular_gen_R(args):
    ...
    test = option_exists(args, '-t')
    batch = option_exists(args, '-b')   ## b sub
    figname = 'angular_gen_R' + '_' + ibin + '_' + index
...
def angular_reco_D(args):
    ...
    test = option_exists(args, '-t')
    batch = option_exists(args, '-b')   ## b sub
    figname = 'angular_reco_D' + '_' + ibin + '_' + index
...
def angular_reco_R(args):
    ...
    test = option_exists(args, '-t')
    batch = option_exists(args, '-b')   ## b sub
    figname = 'angular_reco_R' + '_' + ibin + '_' + index
