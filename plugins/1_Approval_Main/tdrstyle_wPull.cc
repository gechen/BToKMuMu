...
// Margins:
  ...
  tdrStyle->SetPadBottomMargin(0.14); //// 0.14   /////   0.32 for q2 bins 2D projection plots
  tdrStyle->SetPadLeftMargin(0.14);   //// 0.14   /////   0.14 for q2 bins 2D projection plots
...
// For the axis:
  ...
  tdrStyle->SetTickLength(0.04, "XYZ");  //// 0.04  //// 0.055 for for q2 bins 2D projection plots
