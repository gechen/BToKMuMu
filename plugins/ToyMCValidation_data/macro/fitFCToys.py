...
class transfer_thread(Thread):
    ...
    def run(self):
        ...
        sys.stdout.flush()
        cmd=["../fit", "angular2D_Toy"  ,self.fullpath+"/*.root", "--iallpath="+self.headfolder, "--oallpath="+self.fullpath, "--iCombBkgWspacepath="+self.fullpath, "--keeplog", "--keepparam"]
...
headfolders = []
headfolderPattern = re.compile("^afb...._fh....$")
...
fitResultPattern = "wspace_angular2D_bin"+str(theBin)+".root"
for headfolder in headfolders:
