...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   cout<<nentries<<endl;
	...
	TFile *newfile = new TFile("./MC_loose_8TeV_v1_cut0+HLT+Q+B2+resonance-1+OPT+Anti3.root","recreate");
//	TFile *newfile = new TFile("./MC_Signal_8TeV_v4_cut0+HLT+Q+B2+resonance-1+OPT+Anti3.root","recreate");
//	TFile *newfile = new TFile("./MC_Signal_8TeV_v4_cut0+Q+B2+resonance-1+OPT+Anti3_HLT.root","recreate");
