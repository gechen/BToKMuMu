...
// used to generate this class and read the Tree.
   if (tree == 0) {
	   TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../../RootFiles/MC_cut0/BuToMuMuK_MuFilterLoose_8TeV_cut0_v1.root");
	   //TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../../RootFiles/MC_cut0/BToKMuMu_SignalMC_8TeV_v4_cut0_HLT.root");
	   //TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../../RootFiles/MC_cut0/Kst0MuMu_MC_8TeV_v4_cut0_HLT.root");
	   
		//TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../../RootFiles/Files/MC_Signal_8TeV_v4_cut0+HLT+Q+B2_NoGEN.root");
      if (!f || !f->IsOpen()) {
	      f = new TFile("../../RootFiles/MC_cut0/BuToMuMuK_MuFilterLoose_8TeV_cut0_v1.root");
	      //f = new TFile("../../RootFiles/MC_cut0/BToKMuMu_SignalMC_8TeV_v4_cut0_HLT.root");
	      //f = new TFile("../../RootFiles/MC_cut0/Kst0MuMu_MC_8TeV_v4_cut0_HLT.root");
	      
			//f = new TFile("../../RootFiles/Files/MC_Signal_8TeV_v4_cut0+HLT+Q+B2_NoGEN.root");
      }
