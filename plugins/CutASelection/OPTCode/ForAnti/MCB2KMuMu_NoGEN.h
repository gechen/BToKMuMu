...
// used to generate this class and read the Tree.
   if (tree == 0) {
	   //TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../../RootFiles/OPT/BToKMuMu_SignalMC_8TeV_v4_bfAnti_cut1.root");
	   //TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../../RootFiles/OPT/BToKMuMu_SignalMC_8TeV_v4_bfAnti_cut1_NoGEN.root");
	   //TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../../RootFiles/OPT/BToJpsiK_MC_8TeV_v4_bfAnti_cut1.root");
	   //TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../../RootFiles/OPT/BToPsi2SK_MC_8TeV_v4_bfAnti_cut1.root");
	   //TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../../RootFiles/OPT/BToJpsiX_MC_8TeV_v4_bfAnti_cut1.root");
	   //TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../../RootFiles/OPT/BToJpsiK_MC_8TeV_v4_bfAnti_cutJpsi.root");
	   TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../../RootFiles/OPT/BToPsi2SK_MC_8TeV_v4_bfAnti_cutPsip.root");
      if (!f || !f->IsOpen()) {
	      //f = new TFile("../../RootFiles/OPT/BToKMuMu_SignalMC_8TeV_v4_bfAnti_cut1.root");
	      //f = new TFile("../../RootFiles/OPT/BToKMuMu_SignalMC_8TeV_v4_bfAnti_cut1_NoGEN.root");
	      //f = new TFile("../../RootFiles/OPT/BToJpsiK_MC_8TeV_v4_bfAnti_cut1.root");
	      //f = new TFile("../../RootFiles/OPT/BToPsi2SK_MC_8TeV_v4_bfAnti_cut1.root");
	      //f = new TFile("../../RootFiles/OPT/BToJpsiX_MC_8TeV_v4_bfAnti_cut1.root");
	      //f = new TFile("../../RootFiles/OPT/BToJpsiK_MC_8TeV_v4_bfAnti_cutJpsi.root");
	      f = new TFile("../../RootFiles/OPT/BToPsi2SK_MC_8TeV_v4_bfAnti_cutPsip.root");
      }
