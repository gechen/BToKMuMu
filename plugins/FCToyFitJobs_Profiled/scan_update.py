...
def call_fit_2D_Afb(infile, ibin):
    if ibin == 0: bandFh = 0.6 
    elif ibin == 9: bandFh = 0.6
    elif ibin == 1: bandFh = 1.0
    elif ibin == 2: bandFh = 0.4
    elif ibin == 4: bandFh = 0.15
    elif ibin == 6: bandFh = 0.15
    else: 
		bandFh = 0.30
...
def call_fit_2D_Fh(infile, ibin):
    if ibin is 9 or 4: bandAfb = 0.4
    if ibin is 1: bandAfb = 0.6
    if ibin is 2 or 6: bandAfb = 0.1
#    NN = int(2.*bandAfb/stepAfb)
