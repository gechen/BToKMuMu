...
process.ntuple = cms.EDAnalyzer(
   ...
   # TruthMatchKsMaxVtx = cms.untracked.double(10.0), 
    ...
    # HLT-trigger cuts 
    MuonMinPt = cms.untracked.double(0.), # [GeV]
    MuonMaxEta = cms.untracked.double(1000.),  
    MuonMaxDcaBs = cms.untracked.double(1000.), # [cm] 

    MuMuMinPt = cms.untracked.double(0.),      # [GeV/c]
    MuMuMinInvMass = cms.untracked.double(0.), # [GeV/c2]
    MuMuMaxInvMass = cms.untracked.double(1000.), # [GeV/c2]

    MuMuMinVtxCl = cms.untracked.double(0.),  
    MuMuMinLxySigmaBs = cms.untracked.double(0.), 
    MuMuMaxDca = cms.untracked.double(1000.), # [cm]   
    MuMuMinCosAlphaBs = cms.untracked.double(0.),   
