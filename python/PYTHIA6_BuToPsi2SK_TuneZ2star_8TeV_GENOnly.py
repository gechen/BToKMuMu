...
# with command line options: ana/BToKMuMu/python/PYTHIA6_BuPsi2SK_TuneZ2star_8TeV_GEN_cff.py --step GEN --beamspot Realistic8TeVCollision --conditions START53_LV6A1::All --pileup NoPileUp --datamix NODATAMIXER --eventcontent RAWSIM --datatier GEN --no_exec -n 5000000 --fileout BToPsi2SK_MC_OnlyGEN_8TeV.root
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /local/projects/CMSSW/rep/CMSSW/Configuration/GenProduction/python/EightTeV/PYTHIA6_BuToPsi2SK_TuneZ2star_8TeV_cff.py,v $')
)
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('BToPsi2SK_MC_OnlyGEN_8TeV.root'),
...
process.ProductionFilterSequence = cms.Sequence(process.generator+process.bfilter+process.psi2sfilter+process.kfilter)
