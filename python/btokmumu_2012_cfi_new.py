...
process.ntuple = cms.EDAnalyzer(
   ...
   # TruthMatchKsMaxVtx = cms.untracked.double(10.0), 
    ...
    # HLT-trigger cuts 
    MuonMinPt = cms.untracked.double(2.0),# 3.5 # [GeV]
    MuonMaxEta = cms.untracked.double(2.4), # 2.2  
    MuonMaxDcaBs = cms.untracked.double(3.5), # 2.0 # [cm] 

    MuMuMinPt = cms.untracked.double(4.0), # 6.9     # [GeV/c]
    MuMuMinInvMass = cms.untracked.double(0.2), # 1.0  # [GeV/c2]
    MuMuMaxInvMass = cms.untracked.double(6.0), # 4.8  # [GeV/c2]

    MuMuMinVtxCl = cms.untracked.double(0.02),  # 0.10 
    MuMuMinLxySigmaBs = cms.untracked.double(0.1), # 3.0
    MuMuMaxDca = cms.untracked.double(3.0), # 0.5 # [cm]   
    MuMuMinCosAlphaBs = cms.untracked.double(0.1), # 0.9   

    # pre-selection cuts 
    TrkMinPt = cms.untracked.double(0.2), # 0.2 # [GeV/c]
    TrkMinDcaSigBs = cms.untracked.double(0.1), # 0.1 # hadron DCA/sigma w/respect to BS [1.2]
   ...
   # KstarMaxMass = cms.untracked.double(1.04), # [GeV/c2]  + 3 sigma of the width
    ...
    BMinVtxCl = cms.untracked.double(0.01), # 0.01 
    BMinMass = cms.untracked.double(2.0), # 2.0 # [GeV/c2] B+ mass = 5279 MeV  
    BMaxMass = cms.untracked.double(8.0), # 8.0 # [GeV/c2] B+ mass = 5279 MeV  
