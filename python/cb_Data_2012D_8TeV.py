...
config.General.requestName = 'BuToKMuMu_Data_2012D_8TeV_v8'
config.General.transferLogs = False

config.section_('JobType')
config.JobType.psetName = './btokmumu_Data_8TeV.py'
config.JobType.pluginName = 'Analysis'
#config.JobType.outputFiles = ['BuToKMuMu_Data_2012D_8TeV.root']
...
config.Data.outputDatasetTag = 'BuToKMuMu_Data_2012D_8TeV_v8'
